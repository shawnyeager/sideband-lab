...
<header class="site-header">
  ...
  <nav class="site-header__nav">
    ...
    <a href="https://github.com/shawnyeager/sideband-lab" class="site-header__github plausible-event-name=Outbound+GitHub" aria-label="View source on GitHub">
...
<div class="site-header-fixed">${headerMarkup}</div>
`;
